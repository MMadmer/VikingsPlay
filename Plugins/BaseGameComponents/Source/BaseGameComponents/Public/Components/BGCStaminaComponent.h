...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Stamina")
	void SetStaminaNorm(const float NewStaminaNorm)
	{
	...
	UFUNCTION(BlueprintCallable, Category = "Stamina")
	float IsStaminaFull() const { return FMath::IsNearlyEqual(Stamina, MaxStamina); }

	/** Set stamina to full.*/
	UFUNCTION(BlueprintCallable, Category = "Stamina")
	void RecoverStamina() { SetStamina(MaxStamina); }
